...
export function useDownloadProgressToast() {
  ...
  // Built-in AI (modelos GGUF) descarga silenciosa: no se exponen progress
  // toasts al usuario porque la app debe llegar con todo listo. Solo
  // mostramos el toast de Parakeet (transcripción) durante onboarding.
