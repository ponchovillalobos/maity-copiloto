    ...
    >
      <div className="flex flex-col items-center space-y-10">
              ...
              <div key={index} className="flex items-start gap-3">
                <div className="flex-shrink-0 mt-0.5">
                  <div className="w-5 h-5 rounded-full bg-[#e7e7e9] dark:bg-gray-700 flex items-center justify-center">
                    <Icon className="w-3 h-3 text-gray-100 dark:text-gray-200" />
                  </div>
                </div>
                <p className="text-sm text-gray-100 dark:text-gray-200 leading-relaxed">{feature.title}</p>
              </div>
            );
          })}
        </div>
        ...
        <div className="w-full max-w-xs space-y-3">
          ...
          <p className="text-xs text-center text-gray-400 dark:text-gray-400">Toma menos de 3 minutos</p>
        </div>
      </div>
    </OnboardingContainer>
  );
