...
console.log(`GitHub Repository: ponchovillalobos/maity-copiloto`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/ponchovillalobos/maity-copiloto/releases/download/${versionDir}/${filename}`;
...
console.log(`   URL: https://github.com/ponchovillalobos/maity-copiloto/releases/new?tag=v${versionClean}`);
...
console.log(`   curl https://github.com/ponchovillalobos/maity-copiloto/releases/latest/download/latest.json`);
